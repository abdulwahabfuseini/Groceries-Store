    ...
    <div className="w-full px-3 py-6 mx-auto max-w-7xl sm:py-10 sm:px-4">
      ...
      <div className="grid w-full gap-10 sm:grid-cols-5">
        ...
        <div className="w-full sm:col-span-3">
          <h1 className="pb-3 text-2xl font-semibold">{baked?.name}</h1>
          <Rate defaultValue={baked?.rating} allowHalf />
          <p className="py-4 font-semibold ">
            Unit Price: GH₵: <span>{baked?.price.toLocaleString()}</span>
          </p>
          <p>{baked?.desc}</p>
      ...
      <div className="pt-6 font-semibold sm:pt-24">
        <header className="text-xl sm:text-2xl">Related Baked Foods</header>
